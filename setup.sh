...
echo "Installing TensorFlow with CUDA 12.x support" # double check version 
pip install tensorflow[and-cuda]

echo "Installing other dependencies..."
pip install scikit-learn==1.4.0 matplotlib==3.8.0 seaborn==0.12.0 h5py==3.10.0 #check seaborn
